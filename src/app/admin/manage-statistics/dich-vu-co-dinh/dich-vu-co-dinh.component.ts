...
@Component({
  selector: "ngx-dich-vu-co-dinh",
  templateUrl: "./dich-vu-co-dinh.component.html",
  styleUrls: ["./dich-vu-co-dinh.component.scss"],
  animations: [
...
export class DichVuCoDinhComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DichVuCoDinhComponent>
  ) {}
  ...
  ngOnInit(): void {
    ...
    if (this.data.type == "Chua") {
      this.findAllHddvByChuaThanhToanTrongThang();
    } else {
      this.findAllHddvByDaThanhToanTrongThang();
    }
  }
  ...
  findAllHddvByChuaThanhToanTrongThang() {
    this.dichVuService
      .findAllHddvByChuaThanhToanTrongThang(this.data.nam, this.data.thang)
      .subscribe(
        (data) => {
  ...
  findAllHddvByDaThanhToanTrongThang() {
    this.dichVuService
      .findAllHddvByDaThanhToanTrongThang(this.data.nam, this.data.thang)
      .subscribe(
        (data) => {
          this.dichVuSuaChuaList.data = data;
          console.log(this.dichVuSuaChuaList.data);
